...
const TransportControls = ({ transport = Tone.Transport }) => {
  ...
  React.useEffect(() => {
    if (transControlsEl && transControlsEl.current && typeof window !== 'undefined') {
      transControlsEl.current
  ...
  return (
    <div ref={transControlsEl} className="transport-controls">
