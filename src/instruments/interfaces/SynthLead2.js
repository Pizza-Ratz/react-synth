...
import SynthLead2Inst from "../engines/SynthLead2";
import Dial from "../../components/Dial";
import ControlGroup from "../../components/ControlGroup";
import "../../styles/SynthLead2.scss";
import BusContext from "../../contexts/BusContext";
import { dBToKnob, knobToDB } from "../../lib/transformers";
import * as Tone from "tone";

const SynthLead2 = () => {
  const [synth] = React.useState(new SynthLead2Inst());
...
SynthLead2.propTypes = {
  className: PropTypes.string,
};

export default SynthLead2;
